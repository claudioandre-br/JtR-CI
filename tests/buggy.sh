...
function do_help(){
    ...
    echo
    echo 'disable:      remove all "buggy" formats.'
    echo
...
FILES="pbkdf2-hmac-md4_fmt_plug.c pbkdf2-hmac-md5_fmt_plug.c $CL/opencl_pbkdf2_hmac_md4_fmt_plug.c \
       ...
       racf_kdfaes_fmt_plug.c HDAA_fmt_plug.c dmg_fmt_plug.c django_scrypt_fmt_plug.c multibit_fmt_plug.c \
       $CL/opencl_lotus5_fmt_plug.c"
